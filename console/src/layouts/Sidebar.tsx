...
export default function Sidebar({ selectedKey }: SidebarProps) {
  ...
  const collapsedNavItems = [
    ...
    {
      key: "wecom-tenant-monitoring",
      icon: <SparkBarChartLine size={18} />,
      path: "/wecom-tenants/monitoring",
      label: t("nav.wecomTenantMonitoring"),
    },
    {
      key: "wecom-tenant-management",
      icon: <SparkWeChatWorkLine size={18} />,
      path: "/wecom-tenants",
      label: t("nav.wecomTenantManagement"),
    },
    {
      key: "agents",
  ...
  const settingsMenuItems: MenuProps["items"] = [
    {
      key: "platform-ops-group",
      label: collapsed ? null : t("nav.platformOps"),
      children: [
        {
          key: "platform",
          label: collapsed ? null : t("nav.platformOverview"),
          icon: <SparkDataLine size={16} />,
        },
        {
          key: "platform-policies",
          label: collapsed ? null : t("nav.platformPolicies"),
          icon: <SparkScanLine size={16} />,
        },
        {
          key: "platform-users",
          label: collapsed ? null : t("nav.platformUsers"),
          icon: <SparkUserGroupLine size={16} />,
        },
        {
          key: "wecom-tenant-management",
          label: collapsed ? null : t("nav.wecomTenantManagement"),
          icon: <SparkWeChatWorkLine size={16} />,
        },
        {
          key: "wecom-tenant-monitoring",
          label: collapsed ? null : t("nav.wecomTenantMonitoring"),
          icon: <SparkBarChartLine size={16} />,
        },
      ],
    },
