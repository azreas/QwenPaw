...
export const KEY_TO_PATH: Record<string, string> = {
  ...
  "wecom-tenant-monitoring": "/wecom-tenants/monitoring",
  "wecom-tenant-management": "/wecom-tenants",
  "wecom-tenants": "/wecom-tenants",
  skills: "/skills",
...
export const KEY_TO_LABEL: Record<string, string> = {
  ...
  "platform-policies": "nav.platformPolicies",
  "platform-users": "nav.platformUsers",
  "wecom-tenant-monitoring": "nav.wecomTenantMonitoring",
  "wecom-tenant-management": "nav.wecomTenantManagement",
  "wecom-tenants": "nav.wecomTenantManagement",
  skills: "nav.skills",
