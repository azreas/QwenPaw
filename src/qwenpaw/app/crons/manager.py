        ...
        async with rt.sem:
            ...
            try:
                ...
                try:
                    ...
                    dead_letter = getattr(runtime, "dead_letter", None)
                    if dead_letter is not None:
                        from qwenpaw.enterprise.reliability.cron_recovery import (
                            record_cron_failure,
                        )
                    ...
                    logger.debug("cron dead-letter write skipped", exc_info=True)
