...
class WecomChannel(BaseChannel):
    ...
    def build_agent_request_from_native(
        ...
        setattr(
            ...
            SimpleNamespace(
                request_id=str(
                    meta.get("request_id") or payload.get("request_id") or "",
                ),
                trace_id=str(
                    meta.get("trace_id") or payload.get("trace_id") or "",
                ),
            ),
        )
        return request
    ...
    async def _download_media(
        ...
        try:
            ...
            target_dir = Path(save_dir) if save_dir is not None else self._media_dir
            ...
            path = target_dir / f"wecom_{url_hash}_{safe_name}"
