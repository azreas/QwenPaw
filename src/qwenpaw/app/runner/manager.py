...
class ChatManager:
    ...
    def __init__(
        ...
        *,
        ...
        repo_path = getattr(repo, "path", repo.__class__.__name__)
        logger.debug(
            f"ChatManager created with repo: {repo_path}",
        )
    ...
    async def list_chats(
        ...
        async with self._lock:
            repo_path = getattr(self._repo, "path", self._repo.__class__.__name__)
            logger.debug(
                f"list_chats: repo={repo_path}, "
