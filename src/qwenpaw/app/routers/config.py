...
_CHANNEL_CONFIG_CLASS_MAP = {
    ...
    "matrix": MatrixConfig,
    "wecom": WecomConfig,
    "wecom_tenant": WecomTenantConfig,
}
...
async def put_channels(
    ...
    await emit_audit_event(
        ...
        resource_id="channels",
        payload={"changed_key": "channels"},
    )
...
async def put_channel(
    ...
    await emit_audit_event(
        ...
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id=f"channels.{channel_name}",
        payload={"changed_key": f"channels.{channel_name}"},
    )
...
async def put_acp_agent_config(
    ...
    await emit_audit_event(
        request,
        event_type=AuditEventType.CONFIG_UPDATED,
        action="update_acp_agent",
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id=f"acp.{agent_name}",
        payload={"changed_key": f"acp.{agent_name}"},
    )
    schedule_agent_reload(request, agent.agent_id)
...
async def put_agents_llm_routing(
    ...
    await emit_audit_event(
        request,
        event_type=AuditEventType.CONFIG_UPDATED,
        action="update_llm_routing",
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="agents.llm_routing",
        payload={"changed_key": "agents.llm_routing"},
    )
    return body
...
async def put_user_timezone(
    ...
    await emit_audit_event(
        ...
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="user_timezone",
        payload={"changed_key": "user_timezone"},
    )
    return {"timezone": tz}
...
async def put_tool_guard(
    ...
    await emit_audit_event(
        request,
        event_type=AuditEventType.CONFIG_UPDATED,
        action="update_tool_guard",
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="security.tool_guard",
        payload={"changed_key": "security.tool_guard"},
    )
    return body
...
async def put_file_guard(
    ...
    await emit_audit_event(
        request,
        event_type=AuditEventType.CONFIG_UPDATED,
        action="update_file_guard",
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="security.file_guard",
        payload={"changed_key": "security.file_guard"},
    )
...
async def put_skill_scanner(
    ...
    await emit_audit_event(
        request,
        event_type=AuditEventType.CONFIG_UPDATED,
        action="update_skill_scanner",
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="security.skill_scanner",
        payload={"changed_key": "security.skill_scanner"},
    )
    return body
...
async def add_to_whitelist(
    ...
    await emit_audit_event(
        ...
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="security.skill_scanner.whitelist",
        payload={
            "changed_key": "security.skill_scanner.whitelist",
            "skill_name": skill_name,
...
async def put_allow_no_auth_hosts(
    ...
    await emit_audit_event(
        request,
        event_type=AuditEventType.CONFIG_UPDATED,
        action="update_allow_no_auth_hosts",
        outcome=AuditOutcome.SUCCESS,
        resource_type="config",
        resource_id="security.allow_no_auth_hosts",
        payload={"changed_key": "security.allow_no_auth_hosts"},
    )
