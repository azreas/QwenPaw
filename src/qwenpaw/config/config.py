...
class WecomTenantConfig(WecomConfig):
    """WeCom Tenant channel config — same fields as WecomConfig."""
...
class ChannelConfig(BaseModel):
    ...
    wecom_tenant: WecomTenantConfig = WecomTenantConfig()
...
class AgentProfileConfig(BaseModel):
    ...
    user_timezone: str = Field(
        ...
        description=(
            "User IANA timezone for this agent "
            "(e.g. Asia/Shanghai). Defaults to the system timezone."
        ),
    )
...
def load_agent_config(agent_id: str) -> AgentProfileConfig:
    ...
    from .utils import _agent_config_cache, _agent_config_lock
