...
class ReMeLightMemoryManager(BaseMemoryManager):
    ...
    def __init__(
        self, working_dir: str, agent_id: str, agent_config=None,
    ):
        ...
        reme_cfg = agent_cfg.running.reme_light_memory_config
    ...
    def get_embedding_config(self) -> dict:
        ...
        cfg = agent_cfg.running.reme_light_memory_config.embedding_model_config
        return {
            "backend": cfg.backend,
            "api_key": cfg.api_key
