...
export function ContextCompactCard({ maxInputLength }: ContextCompactCardProps) {
  ...
  return (
    <Card title={t("agentConfig.contextCompactTitle")}>
      <Form.Item
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: t("agentConfig.tokenCountEstimateDivisorRequired") }]}
      ...
      >
        <Input
          disabled
          value={contextCompactReserveThreshold > 0 ? contextCompactReserveThreshold.toLocaleString() : ""}
