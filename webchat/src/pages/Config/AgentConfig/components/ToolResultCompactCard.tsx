...
export function ToolResultCompactCard() {
  ...
  return (
    <Card title={t("agentConfig.toolResultCompactTitle")}>
      <Form.Item
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: t("agentConfig.toolResultCompactOldThresholdRequired") }]}
        ...
        rules={[
          { required: true, message: t("agentConfig.toolResultCompactRecentThresholdRequired") },
          {
            validator: async (_, value) => {
              const oldMaxBytes = form.getFieldValue(["tool_result_compact", "old_max_bytes"]);
              if (typeof value !== "number" || typeof oldMaxBytes !== "number" || value >= oldMaxBytes) {
                return;
              }
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: t("agentConfig.toolResultCompactRetentionDaysRequired") }]}
